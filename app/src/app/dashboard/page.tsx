...
<div className='fixed z-20 top-0 w-full h-16 bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-4'>
    ...
    <button onClick={() => setClick(!click)} className='md:hidden relative'>
     ...
     layoutId='menu-icon'
     xmlns="http://www.w3.org/2000/svg"  width={24}  height={24}  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth={1}  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-menu-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 6l16 0" /><path d="M4 12l16 0" /><path d="M4 18l16 0" /></motion.svg>
}

{
    ...
    transition={{ duration: 0.5, ease: "easeInOut" }}
    layoutId='menu-icon'
    xmlns="http://www.w3.org/2000/svg"  width={24}  height={24}  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth={1}  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-x"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" /></motion.svg>
}
<AnimatePresence>
    <motion.div 
    ...
    exit={{ x: 30 , opacity: 0 }}
    transition={{ duration: 0.5, ease: "easeInOut" }}
    className={`absolute w-full top-8 -left-50 h-full bg-neutral-50 dark:bg-neutral-200 border-b border-neutral-200 dark:border-neutral-800 ${click ? "block" : "hidden"}`}>
