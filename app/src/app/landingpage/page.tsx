    ...
    <div className="min-h-screen w-full relative">
      ...
      <div className='relative z-10'>
        <div className='flex flex-col max-w-4xl items-center justify-center h-screen mx-auto'>
          <h1 className='text-7xl/20 text-neutral-100 font-medium tracking-tight text-center  mx-auto'>
            Start <span className='text-[#acadf7] relative p-1 bg-violet-500/10'>
          ...
          <div className='w-full relative group flex items-center justify-center mt-8'>
            ...
            <button className='bg-neutral-800 p-4 relative z-10 rounded-tr-lg rounded-br-lg border border-l-0 border-neutral-700'
            onClick={() => {
          ...
          <p className='text-neutral-500 text-center mx-auto text-lg mt-8'>
            Your complete roadmap to making your first open source contribution <br/> and becoming part of the global developer community.
          </p>
        </div>
      </div>
    </div>
